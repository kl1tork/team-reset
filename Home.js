...
export default function Home() {
  ...
  return (
    <div className="page">
      ...
      <section className="section">
        <h2>О нас</h2>
        <p>Team Reset — система диагностики и трансформации команд.</p>
      </section>
      ...
      <section className="section">
        ...
        <div className="card caseCard">
          <div className="bigNumber smallGold">1 000 000 000 ₸</div>
          <p className="caseDesc">Прибыль за 6 месяцев сопровождения</p>
        ...
        <div className="card caseCard">
          <div className="bigNumber smallGold">+42% дохода</div>
          <p className="caseDesc">Рост эффективности команды</p>
        ...
        <div className="card caseCard">
          <div className="bigNumber smallGold">-70% конфликтов</div>
          <p className="caseDesc">Снижение напряжения внутри команды</p>
  ...
  <div className="grid">
    ...
    <div className="card vip">
      ...
      <section className="section">
        ...
        <div className="grid">
          <div className="card">
            <p>“После диагностики команда перестала терять деньги.”</p>
          </div>

          <div className="card">
            <p>“Мы убрали хаос в управлении.”</p>
          </div>

          <div className="card">
            <p>“Рост выручки пошёл уже в первый месяц.”</p>
          </div>
        </div>
      </section>
        ...
        <div className="modalOverlay" onClick={() => setOpen(false)}>
          <div className="modalBox" onClick={(e) => e.stopPropagation()}>
            ...
            <label className="agreeBox">
              ...
              <span>
                Я согласен с политикой и офертой
              </span>
            </label>
